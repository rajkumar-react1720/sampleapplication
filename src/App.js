    ...
    return (
      <div>
        <Wrapper >
          ...
          <NavSeparator />
          <ContactUs onClick={(e) => { this.navigateManager(e) }}> Contact Us</ContactUs>
          <NavSeparator />
          <LoginInButton onClick={()=>{this.showLogin()}}>Login</LoginInButton>
          <Login/>
        </Wrapper>
        ...
        <ProductContainer onClick={(e) => { this.navigateManager(e, 'product') }}>
        ...
        <ProductContainer>
            {this.props.userInfo && this.props.userInfo.data && this.props.userInfo.data.items.map(value=>(
              <Product>
                 <img style={{ marginTop: '60px', marginLeft: '40px' }} src={value.avatar_url} />
              </Product>
            ))}
        </ProductContainer>
